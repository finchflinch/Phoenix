...
face_detector = cv2.CascadeClassifier('C:/Users/Mr. Nitin Tiwari/AppData/Local/Programs/Python/Python37-32/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
while (True):
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.imwrite("training_data/Prathamesh." + str(face_id) + '.' + str(count) + ".jpg", gray[y:y + h, x:x + w])
